...
namespace MnM.GWS 
{
    ...
    public struct Vector3 : IEquatable<Vector3>, IFormattable
    {
        ...
        public Vector3(PointF value, float z) : this(value.X, value.Y, z) { }
        ...
        public override int GetHashCode()
        {
            ...
            hash = Implementation.Combine(hash, this.Y.GetHashCode());
            hash = Implementation.Combine(hash, this.Z.GetHashCode());
            return hash;
        }
        ...
        public float LengthSquared() =>
            (float)(MathHelper.Sqr(X) + MathHelper.Sqr(Y) + MathHelper.Sqr(Z));
        #endregion Public Instance Methods
        ...
        public static float DistanceSquared(Vector3 value1, Vector3 value2) =>
            (float)
            (MathHelper.Sqr(value1.X - value2.X) +
                 MathHelper.Sqr(value1.Y - value2.Y) +
                 MathHelper.Sqr(value1.Z - value2.Z));
