...
namespace MnM.GWS
{
    ...
    {
        private const float RotationEpsilon = 0.001f * Geometry.PI / 180f;     // 0.1% of a degree
        ...
        /// <returns>A scaling matrix.</returns>
        public static Matrix3x2 CreateScale(PointF scales)
        {
            Matrix3x2 result = new Matrix3x2();
        ...
        /// <returns>A scaling matrix.</returns>
        public static Matrix3x2 CreateScale(PointF scales, PointF centerPoint)
        {
            Matrix3x2 result = new Matrix3x2();
        ...
        public static Matrix3x2 CreateRotation(float radians)
        {
            ...
            else if (radians > Geometry.PI / 2 - RotationEpsilon && radians < Geometry.PI / 2 + RotationEpsilon)
            {
                // Exact case for 90 degree rotation.
                c = 0;
                s = 1;
            }
            else if (radians < -Geometry.PI + RotationEpsilon || radians > Geometry.PI - RotationEpsilon)
            {
