...
namespace MnM.GWS
{
    ...
    public
#endif
        abstract class SdlSoundBase : GwsSound
        {
            ...
            #region SDL BINDINGS
            private const string libSDL = Implementation.libSDL;
            ...
            //SDL_AudioInit
            static int InitAudio(string driver_name) => audioInit(Implementation.UTF8_ToNative(driver_name));
            ...
            protected static string GetAudioDeviceName(int index, int iscapture) =>
                Implementation.UTF8_ToManaged(getAudioDeviceName(index, iscapture));
            ...
            //SDL_GetAudioDriver
            internal static string GetAudioDriver(int index) => Implementation.UTF8_ToManaged(getAudioDriver(index));
            ...
            protected static string GetCurrentAudioDriver() => Implementation.UTF8_ToManaged(getCurrentAudioDriver());
        ...
        unsafe class SdlAudio : SdlSoundBase, IAudio
        {
            ...
            unsafe void FillBuffer(IntPtr usrdata, byte* stream, int len)
            {
                ...
                fixed (byte* src = input.data)
                    MnM.GWS.Implementation.CopyMemory((IntPtr)src, input.pointer, (IntPtr)stream, 0, len/4);
                input.pointer += len;
            }
            public override void Dispose()
            {
