...
namespace MnM.GWS
{
    ...
    class KeyEventArgs : EventArgs, IKeyEventArgs
    {
        ...
        {
            KeyCode = (Keys)args.ScanCode;
            k = args.KeyCode;
            state = Keyboard.IsKeyDown(KeyCode) ? KeyState.Down : KeyState.Up;
        }

        public bool Alt =>
            Keyboard[Keys.AltLeft] || Keyboard[Keys.AltRight];
        public bool Control =>
            Keyboard[Keys.ControlLeft] || Keyboard[Keys.ControlRight];
        public bool Shift =>
            Keyboard[Keys.ShiftLeft] || Keyboard[Keys.ShiftRight];
    ...
    class MouseEventArgs : EventArgs, IMouseEventArgs
    {
        ...
        public MouseEventArgs(int x, int y, MouseState state = 0,
            MouseButton button = 0, int clicks = 0, int delta = 0, Point dragStart = default) :
            this(x, y)
        {
            State = state;
            Clicks = clicks;
        ...
        /// <summary>
        /// Gets a <see cref="MnM.GWS.PointF"/> representing the location of the mouse for the event.
        /// </summary>
    ...
    struct Keyboard : IEquatable<Keyboard>
    {
        ...
        private const int NumInts = ((int)GWS.Keys.LastKey + IntSize - 1) / IntSize;
        ...
        {
            return code >= 0 && code < (short)GWS.Keys.LastKey && ReadBit(code);
        }
    ...
    struct GamePadThumbSticks : IEquatable<GamePadThumbSticks>, IGamePadThumbSticks
    {
        ...
        public PointF Left
        {
            get { return new PointF(left_x * ConversionFactor, left_y * ConversionFactor); }
        }
        ...
        public PointF Right
        {
            get { return new PointF(right_x * ConversionFactor, right_y * ConversionFactor); }
        }
